<div class="box">
    <form action="<?= base_url('Laporanbarang/Cetaklaporanpenbarven') ?>" method="post">
        <div class="box-header">
            <h3 class="box-title">LAPORAN PENERIMAAN BARANG VENDOR</h3>
        </div>
        <div class="box-body">
            <div class="row">
                <div class="col-md-3">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Dari Tanggal Terima</label>
                                <input type="date" name="tglstart" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Sampe Tanggal Terima</label>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_referensi" id="no_referensi" class="form-control">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="form-group">

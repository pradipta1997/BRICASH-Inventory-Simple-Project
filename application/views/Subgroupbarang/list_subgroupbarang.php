        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <span <?php echo $My_Controller->savePermission; ?>>
                    | <button type="button" id='addSubgroupbarang' class='btn btn-info'>
                        Add New <i class="fa fa-plus"></i>
                    </button>
                </span>
            </header>
            <div class="panel-body">
                <table id="tableSubgroupbarang" class="table table-bordered" style="width: 100%;">
                    <thead>
                        <tr role="row">
                            <th>No</th>
...
<script>
    ...
    function activeSubgroupbarang(id_sgbarang) {
        Swal.fire({
            title: "Are you sure?",
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    url: urlSubgroupbarang + "activeSubgroupbarang",
                    dataType: 'JSON',
                    success: function(response) {
                        if (response) {

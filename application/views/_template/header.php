...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/bower_components2/datatable-responsive/css/responsive.dataTables.min.css">
    <!-- DataTables Button -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/bower_components2/datatable-button/css/buttons.bootstrap.min.css">
    <!--Sweetalert & Toastr-->

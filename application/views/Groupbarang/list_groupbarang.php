        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <span <?php echo $My_Controller->savePermission; ?>>
                    | <button type="button" id='addGroupbarang' class='btn btn-info'>
                        Add New <i class="fa fa-plus"></i>
                    </button>
                </span>
            </header>
            <div class="panel-body">
                <table id="tableGroupbarang" class="table table-bordered" style="width: 100%;">
                    <thead>
                        <tr role="row">
                            <th>No</th>
...
<script>
    ...
    function activeGroupbarang(id_gbarang) {
        Swal.fire({
            title: "Are you sure?",
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    url: urlGroupbarang + "activeGroupbarang",
                    dataType: 'JSON',
                    success: function(response) {
                        if (response) {
